...
export const CHORDS: Chord[] = [
  ...
  },
  {
    ...
    baseFret: 2,
    barre: [0, 5],
    tip: "The F shape moved up two frets. Slightly easier than F — less string tension.",
  },
  {
    id: "F#m",
    ...
    baseFret: 2,
    barre: [0, 5],
    tip: "F# with the middle finger lifted. Minor barre shapes are the easier of the two.",
  },
  {
    id: "Bb",
    name: "B flat (barre)",
